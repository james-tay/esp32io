...
#define BUF_LEN_WORKER_RESULT 1280      // worker thread's "result_msg" buffer
...
struct runtime_data {
  ...
  SemaphoreHandle_t L_hcsr04 ;          // prevent ultrasonic interference
  SemaphoreHandle_t L_i2c ;             // lock for "Wire.xxx()" transactions
